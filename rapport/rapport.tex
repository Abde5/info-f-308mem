...
\begin{figure}[h]
  ...
  % talk about clojure / supercollider / overtone now 
...
\subsection{Overtone}
\begin{comment}
  Parler d'Overtone-sup  Parler d'Overtone-supercollider, les methodes que ça nous donne etc
  Parler d'Overtone-supercollider, les methodes que ça nous donne etc
ercollider, les methodes que ça nous donne etc
